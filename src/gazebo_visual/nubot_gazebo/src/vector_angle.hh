...
/* Desc: As an extension to the operation of gazebo::math::Vector3d
...
double get_angle_PI(math::Vector3d reference_vector, math::Vector3d target_vector);   // return angle range [-PI,PI]
double get_angle_2PI(math::Vector3d reference_vector, math::Vector3d target_vector);  // return angle range [0, 2*PI]

double get_cos_angle(math::Vector3d vector1, math::Vector3d vector2)
{
    math::Vector3d vector1_norm = vector1.Normalize();
    math::Vector3d vector2_norm = vector2.Normalize();
    return vector1_norm.Dot(vector2_norm);
}

double get_sin_angle(math::Vector3d reference_vector, math::Vector3d target_vector)
{
    math::Vector3d reference_vector_norm = reference_vector.Normalize();
    math::Vector3d target_vector_norm = target_vector.Normalize();
    math::Vector3d cross_vector = reference_vector_norm.Cross(target_vector_norm);
