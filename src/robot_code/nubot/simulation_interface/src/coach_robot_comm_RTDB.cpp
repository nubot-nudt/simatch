...
// This is for simulation with RTDB only. For convenience, we don't use RTDB now.
// If you want to use RTDB, you should also modify nobot.conf to add teamatesinfo_sim to
// received teamates info as an array for simulation purpose.
